...
export default function PostForm({ type, onSubmit, onClose }) {
                    ...
                    <>
                        <div>
                            ...
                            <select
                                ...
                                className="w-full px-4 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                            >
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                className="w-full px-4 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all resize-none"
                            />
                        </div>
                ...
                <div className="sticky top-0 bg-white border-b border-gray-200 px-6 py-4 rounded-t-3xl">
                    <div className="flex items-center justify-between">
                        <h2 className="text-xl font-bold text-gray-900">
                            {type === 'lost-found' && 'Report Item'}
                            {type === 'marketplace' && 'List Product'}
                            {type === 'cabpool' && 'Create Ride'}
                        </h2>
                        <button
                            onClick={onClose}
